...
{
    [ApiVersion("1.0")]//Opción para señalar la versión del controlador
    ...
    public class UsersController : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")]//De esta forma, esta ruta,sólo estará disponible para la versión 1.0 del controlador
        [HttpGet(Name ="GetUserData")]
        public async Task<IActionResult> GetUsersDataAsyn()
        {
            ...
            return Ok(usersData);//Devolvemos los datos de los usuarios solicitados al API restful
        }
    }
}
